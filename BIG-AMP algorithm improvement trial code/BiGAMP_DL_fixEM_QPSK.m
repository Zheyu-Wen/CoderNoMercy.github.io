function [estFin,optFin,EMoptFin,estHist]...
    = BiGAMP_DL_fixEM_QPSK(Y,problem,BiGAMPopt, PrioriIn, EMopt)
...
while stop < 2
    ...
    [estFin2,BiGAMPopt,estHist2,state] = BiGAMP_test(gX, gA, gOut, problem, BiGAMPopt,state, PrioriIn); % state evolution test 
